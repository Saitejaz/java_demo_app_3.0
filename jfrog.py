...
def jfrogUpload() :
    ...
    url = "http://52.87.165.146:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
    file_path = '/var/lib/jenkins/workspace/jenkins/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Sai@9999' #replace 'your password with ur actual password'
